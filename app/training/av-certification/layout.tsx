...
export const metadata: Metadata = {
  ...
  description:
    'The only global certification for escort operators working alongside autonomous trucks. HC Certified, AV-Ready, and Elite tiers. Aurora, Kodiak, Waymo corridors. 57 countries.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Get certified to escort autonomous freight. 3 tiers. 57 countries. The global standard.',
    type: 'website',
  },
};
