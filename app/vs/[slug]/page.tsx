...
const COMPETITORS: Record<string, Competitor> = {
  'oversize-io': {
    ...
    description: 'Oversize.io offers permit and weight calculators. Haul Command offers that plus a full marketplace, directory, training academy, trust system, and 120-country global coverage.',
    features: [
      ...
      { feature: 'Operator directory',          hc: true, hcNote: '120 countries, verified',   comp: false, compNote: 'US only, unverified' },
      ...
      { feature: 'Global coverage',             hc: true, hcNote: '120 countries',             comp: false, compNote: 'US only' },
    ...
    whySwitchReasons: [
      ...
      { title: 'Global operator directory', body: 'Haul Command indexes operators across 120 countries with real-time availability, trust scores, and verified credentials.' },
  ...
  'ods-north-america': {
    ...
    features: [
      ...
      { feature: 'Operator directory',          hc: true, hcNote: '120 countries',              comp: false, compNote: 'Not available' },
      { feature: 'Load board',                  hc: true, hcNote: 'Two-sided marketplace',     comp: false, compNote: 'Not available' },
      ...
      { feature: 'Global coverage',             hc: true, hcNote: '120 countries',              comp: false, compNote: 'North America only' },
    ...
    whySwitchReasons: [
      ...
      { title: 'Global from day one', body: 'Haul Command covers 120 countries. ODS is limited to North America.' },
  ...
  'wideloadshipping': {
    ...
    features: [
      { feature: 'Transport directory',         hc: true, hcNote: 'Verified, 120 countries',   comp: true,  compNote: 'Basic US directory' },
  ...
  'heavyhaulers': {
    ...
    features: [
      ...
      { feature: 'Global coverage',             hc: true, hcNote: '120 countries',               comp: false, compNote: 'US-focused' },
    ],
    whySwitchReasons: [
