...
export const metadata: Metadata = {
  ...
  description: 'End-to-end project planning for complex heavy haul moves. Multi-escort coordination, permit sequencing, route engineering, and staging logistics across priority markets.',
