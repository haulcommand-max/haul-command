    ...
    <>
      ...
      <main style={{ minHeight: '100vh', background: '#06080f', color: '#e5e7eb', fontFamily: "'Inter', system-ui" }}>
            ...
            <div style={{ display: 'flex', gap: 32, flexWrap: 'wrap', alignItems: 'flex-start', justifyContent: 'space-between' }}>
              <div style={{ flex: 1, minWidth: 280 }}>
                ...
                <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                  <Link href="/directory" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 28px', borderRadius: 12, background: `linear-gradient(135deg, ${gold}, #E4B872)`, color: '#000', fontSize: 14, fontWeight: 900, textDecoration: 'none' }}>🔍 Find Carriers</Link>
                  <Link href="/loads" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 24px', borderRadius: 12, background: 'rgba(34,197,94,0.1)', border: '1px solid rgba(34,197,94,0.25)', color: '#22C55E', fontSize: 14, fontWeight: 800, textDecoration: 'none' }}>📦 Post a Load</Link>
                  <Link href="/claim" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 20px', borderRadius: 12, background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', color: '#e5e7eb', fontSize: 14, fontWeight: 700, textDecoration: 'none' }}>🚛 List Your Operation</Link>
                </div>
              </div>
        ...
        <section style={{ maxWidth: 1100, margin: '0 auto', padding: '0 20px 2rem', display: 'flex', gap: 10, flexWrap: 'wrap' }}>
          <Link href="/glossary/heavy-haul" style={{ padding: '8px 14px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 9, fontSize: 12, fontWeight: 600, color: '#9CA3AF', textDecoration: 'none' }}>📖 What Is Heavy Haul?</Link>
          ...
          <Link href="/pricing" style={{ padding: '8px 14px', background: 'rgba(34,197,94,0.06)', border: '1px solid rgba(34,197,94,0.15)', borderRadius: 9, fontSize: 12, fontWeight: 700, color: '#22C55E', textDecoration: 'none' }}>💲 Carrier Plans</Link>
        </section>
        ...
        <NoDeadEndBlock
          ...
          moves={[
            { href: '/directory', icon: '🔍', title: 'Find Carriers', desc: 'Browse verified by state & equipment', primary: true, color: gold },
            { href: '/loads', icon: '📦', title: 'Post a Load', desc: 'Get quotes from qualified carriers', primary: true, color: '#22C55E' },
            { href: '/tools/escort-calculator', icon: '🧮', title: 'Escort Calculator', desc: 'How many pilot cars?' },
            { href: '/escort-requirements', icon: '⚖️', title: 'State Rules', desc: 'Permit & escort requirements' },
            { href: '/claim', icon: '🚛', title: 'List Your Carrier', desc: 'Free directory listing' },
