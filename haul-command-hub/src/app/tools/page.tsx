...
const TOOL_SUITES = [
  {
    id: 'suite-1',
    title: 'Suite 1 — Load Planning & Risk',
    icon: '📦',
    tools: [
      ...
      { href: '/tools/bridge-formula',       icon: '🌉', title: 'Federal Bridge Formula',    desc: 'Federal Formula B — axle legality instant check',            hot: true },
  ...
  },
  {
    ...
    icon: '📋',
    tools: [
      { href: '/tools/escort-calculator',  icon: '🧮', title: 'Route Escort Calculator', desc: 'All escort requirements on every state in your route',       hot: true },
      { href: '/tools/escort-rules',       icon: '🚔', title: 'State Escort Rules',      desc: 'Dimension thresholds for pilot cars and police escorts',     hot: true },
      { href: '/tools/permit-checker',     icon: '✅', title: 'Permit Need Checker',     desc: 'Check if your load dimensions require oversize permits',     hot: true },
      ...
      { href: '/tools/friday-checker',     icon: '📅', title: 'Friday Weekend Checker',  desc: 'Can I move this Friday? Weekend curfew instant check',       hot: false },
      { href: '/tools/cross-border',       icon: '🌍', title: 'Cross-Border Comparator', desc: 'Side-by-side regulations for any two countries',        hot: true },
      { href: '/tools/compliance-card',    icon: '🛡️', title: 'Compliance Report Card',  desc: 'Load compliance summary generated for your move',         hot: false },
    ],
  },
  {
    id: 'suite-3',
    title: 'Suite 3 — Quoting & Operations',
    icon: '💰',
    tools: [
      { href: '/tools/cost-estimator',   icon: '🧾', title: 'Convoy Cost Estimator',  desc: 'Full convoy overhead based on state-specific market data',    hot: false },
      { href: '/tools/rate-estimator',   icon: '📈', title: 'Oversize Rate Estimator',desc: 'Live spot market rate projections for oversize loads',      hot: true },
      { href: '/tools/rate-advisor',     icon: '💰', title: 'Pilot Car Rate Advisor', desc: 'Corridor-specific rate recommendations for operators',        hot: true },
      { href: '/tools/regulation-alerts', icon: '🚨', title: 'Corridor Regulation Alerts',desc: 'DOT shutdowns, weather delays, curfew hits before they cost', hot: true },
      { href: '/tools/superload-alerts', icon: '⚠️', title: 'Superload Activity Alerts',desc: 'Live tracking of mega-moves blocking major corridors',        hot: false },
      { href: '/tools/load-board-ingest', icon: '📥', title: 'Load Board Profit Scorer',desc: 'AI-analyzed loads from major boards with profit scoring',     hot: false },
      { href: '/tools/discovery-map',   icon: '📍', title: 'Oversize Discovery Map', desc: 'Visual escort supply + demand across all global markets',           hot: false },
    ],
  },
  {
    id: 'suite-4',
    title: 'Suite 4 — Business & Security',
    icon: '🏢',
    tools: [
      { href: '/tools/broker-verify',        icon: '🔒', title: 'Broker Trust Validator',      desc: 'Verify credit score and payment history of freight brokers', hot: true },
      { href: '/insurance',                  icon: '🏥', title: 'Commercial Insurance Quoter', desc: 'Get competitive quotes for pilot car & heavy haul insurance', hot: true },
      { href: '/financing',                  icon: '🏦', title: 'Equipment Finance Calculator',desc: 'Calculate payments for trucks, trailers, and escort gear', hot: false },
      { href: '/fuel-card',                  icon: '⛽', title: 'Fuel Discount Calculator',    desc: 'See exact savings on diesel across our partner network', hot: true },
    ],
  },
  {
    id: 'suite-5',
    ...
    icon: '🚀',
    tools: [
      { href: '/tools/hotel-finder',         icon: '🏨', title: 'Oversize Hotel & Stop Finder', desc: 'Hotels with pilot car rates + truck stops with showers & WiFi', hot: true },
      { href: '/tools/certifications',       icon: '🎓', title: 'Certification Directory',   desc: 'Find PEVO, Flagger, and WITPAC training courses by state', hot: true },
      { href: '/drone-survey',               icon: '🚁', title: 'Drone Route Survey Hub',    desc: 'Book specialized drone operators for complex bridge surveys', hot: false },
      { href: '/carbon',                     icon: '🌱', title: 'Carbon Emission Estimator', desc: 'Calculate the carbon footprint of your heavy haul convoy', hot: false },
      { href: '/tools/av-readiness',         icon: '🤖', title: 'AV Haul Readiness Checker', desc: 'Is your route eligible for autonomous heavy freight?',        hot: true },
    ],
  },
];
