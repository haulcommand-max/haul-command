...
export const metadata: Metadata = {
    ...
    keywords: [
        ...
        'pilot car jobs',
        'pilot car near me',
        'become a pilot car operator',
        'pilot car certification',
        'escort vehicle jobs',
        'heavy haul escort',
        'oversize load pilot car',
        'pilot car directory',
        'pilot car rates per mile',
    ...
    '@graph': [
        ...
        },
        {
            ...
            mainEntity: [
                {
                    '@type': 'Question',
                    name: 'What does a pilot car operator do?',
                    acceptedAnswer: { '@type': 'Answer', text: 'A pilot car operator drives an escort vehicle ahead of or behind an oversize or overweight load to warn motorists, assist with navigation, and ensure the load moves safely and legally through every jurisdiction.' },
                },
                {
                    '@type': 'Question',
                    name: 'How much do pilot car operators make per mile?',
                    acceptedAnswer: { '@type': 'Answer', text: 'Pilot car rates typically range from $1.50 to $3.50 per mile for single-car escorts. Superload escorts and multi-car formations command $3.50 to $6.00+ per mile. Day rates range from $300 to $700 depending on state, load type, and route complexity.' },
                },
                {
                    '@type': 'Question',
                    name: 'What certifications do pilot car operators need?',
                    acceptedAnswer: { '@type': 'Answer', text: 'Requirements vary by state but typically include a valid driver\'s license, liability insurance ($300K–$1M), a PEVO or state-approved escort certification, and in some states a specific pilot car certification card. Height pole operators require additional equipment certification.' },
                },
                {
                    '@type': 'Question',
                    name: 'How do I find pilot car jobs?',
                    acceptedAnswer: { '@type': 'Answer', text: 'Claim your free Haul Command listing to appear in the pilot car directory. Brokers and carriers search for available operators by state and specialty. You can also browse the oversize load board directly to bid on open loads needing escort coverage.' },
                },
                {
                    '@type': 'Question',
                    name: 'How do I get verified as a pilot car operator on Haul Command?',
                    acceptedAnswer: { '@type': 'Answer', text: 'Claim your free listing on Haul Command, upload your certifications and insurance documents, and complete the verification checklist. Verified operators receive a badge that increases visibility and broker trust.' },
                },
            ],
        },
    ],
    ...
    return (
        <>
            ...
            <main style={{ minHeight: '100vh', background: '#06080f', color: '#e5e7eb' }}>
                            ...
                            <div style={{ flex: 1, minWidth: 280 }}>
                                ...
                                <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                                    ...
                                    <Link href="/claim" style={{
                                        ...
                                        color: '#22C55E', fontSize: 14, fontWeight: 800, textDecoration: 'none',
                                    }}>
                                        ✓ Claim Free Listing
                                    </Link>
                                    <Link href="/directory" style={{
                                        ...
                                        color: '#e5e7eb', fontSize: 14, fontWeight: 700, textDecoration: 'none',
                                    }}>
                                        🔍 Find Operators
                                    </Link>
                                </div>
                ...
                {/* ── Role Chooser (Broker vs Operator) ─────── */}
                <section style={{ maxWidth: 1100, margin: '0 auto', padding: '2rem 20px 1.5rem' }}>
                    <p style={{ fontSize: 12, fontWeight: 700, color: 'rgba(255,255,255,0.35)', textTransform: 'uppercase', letterSpacing: '0.1em', margin: '0 0 12px', textAlign: 'center' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 10, maxWidth: 900, margin: '0 auto' }}>
                        {[
                            ...
                            <Link key={r.href + r.title} href={r.href} style={{
                ...
                {/* ── Monetization: Verified Badge Upgrade CTAs ─ */}
                <section style={{ maxWidth: 1100, margin: '0 auto', padding: '0 20px 2rem' }}>
                    <div style={{
                        display: 'flex', gap: 12, flexWrap: 'wrap',
                        padding: '20px 24px', borderRadius: 16,
                        background: 'rgba(212,168,68,0.05)', border: '1px solid rgba(212,168,68,0.15)',
                    }}>
                        <div style={{ flex: 1, minWidth: 240 }}>
                            ...
                            <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.55)', margin: '0 0 14px', lineHeight: 1.5 }}>
                                Verified operators receive 3× more broker contact requests. Upload certs, insurance, and PEVO card — get badged and rise in search results.
                            </p>
                            <div style={{ display: 'flex', gap: 8 }}>
                                <Link href="/claim" style={{ padding: '10px 20px', borderRadius: 10, background: gold, color: '#000', fontSize: 13, fontWeight: 800, textDecoration: 'none' }}>
                                    Claim Free Listing
                                </Link>
                                <Link href="/pricing" style={{ padding: '10px 16px', borderRadius: 10, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', color: '#e5e7eb', fontSize: 13, fontWeight: 700, textDecoration: 'none' }}>
                                    See Pro Plans
                                </Link>
                            </div>
                        </div>
                ...
                <section style={{ maxWidth: 1100, margin: '0 auto', padding: '0 20px 2.5rem' }}>
                    <h2 style={{ fontSize: 17, fontWeight: 800, color: '#f9fafb', margin: '0 0 6px' }}>
                        Find Pilot Car Operators by State
                    </h2>
                    <p style={{ fontSize: 13, color: '#6b7280', margin: '0 0 16px', lineHeight: 1.5 }}>
                        Most active heavy haul markets — click any state to see available operators.
                    </p>
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                        {TOP_STATES.map(state => (
                            <Link key={state} href={`/find/pilot-car-operator/${state.toLowerCase().replace(/\s+/g, '-')}`} style={{
                        ...
                        <Link href="/directory" style={{
                            ...
                            background: `rgba(212,168,68,0.08)`, border: `1px solid rgba(212,168,68,0.2)`,
                ...
                {/* ── Rate Reference ─────────────────────────── */}
                <section style={{ maxWidth: 1100, margin: '0 auto', padding: '0 20px 2.5rem' }}>
                    <h2 style={{ fontSize: 17, fontWeight: 800, color: '#f9fafb', margin: '0 0 14px' }}>
                        Pilot Car Rates — What to Charge in 2025
                    </h2>
                ...
                <section style={{ maxWidth: 800, margin: '0 auto', padding: '0 20px 2.5rem' }}>
                    ...
                    {[
                        ...
                        { q: 'What is PEVO certification?', a: 'PEVO (Pilot/Escort Vehicle Operator) certification is a nationally recognized credential verifying a pilot car operator\'s knowledge of escort procedures, safety requirements, and state regulations. Many states require PEVO or equivalent state certification.' },
                    ].map(({ q, a }) => (
                        <details key={q} style={{ marginBottom: 10, borderRadius: 12, background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.06)', overflow: 'hidden' }}>
                            ...
                            <p style={{ padding: '12px 18px 16px', margin: 0, fontSize: 13, color: 'rgba(255,255,255,0.6)', lineHeight: 1.6, borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                                {a}
                            </p>
                        </details>
                    ))}
                ...
                <section style={{ maxWidth: 800, margin: '0 auto', padding: '0 20px 2.5rem' }}>
                    <div style={{ padding: '24px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 16 }}>
                        ...
                        <div style={{ fontSize: 14, color: '#9ca3af', lineHeight: 1.8, display: 'flex', flexDirection: 'column', gap: 12 }}>
                            <p style={{ margin: 0 }}>
                                Pilot car operators — also called escort vehicle operators or EVOs — are a critical component of every oversize and overweight load movement. Haul Command maintains the most comprehensive directory of certified escort vehicle operators across all 50 US states and 120 countries globally.
                            </p>
                            <p style={{ margin: 0 }}>
                                Each state has its own escort vehicle requirements, certification standards, and equipment rules. Use the{' '}
                                <Link href="/escort-requirements" style={{ color: gold }}>state requirements tool</Link>{' '}
                                to look up exactly what is required before booking or operating in any jurisdiction.
                            </p>
                            <p style={{ margin: 0 }}>
                                Whether you are a broker needing certified escort coverage for a permitted load, or a pilot car operator looking to grow your client base and claim territory corridors, Haul Command connects the heavy haul ecosystem in real time.
                            </p>
                        </div>
                    </div>
                </section>
