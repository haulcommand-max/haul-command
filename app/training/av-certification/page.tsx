...
const MODULES = [
  ...
  { num: 2, title: 'Global Regulations Overview', dur: '60 min', tier: 'T1', desc: 'Escort requirements across priority markets — width/height thresholds, permit types, curfews, cross-border protocols.' },
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <div style={{
            ...
            ðŸŒ MARKET-SPECIFIC STANDARD · priority markets
          </div>
          <h1 style={{
