...
export default function PressPage() {
  const releases = [
    ...
    { date: '2025-02', title: 'Platform Expands to 50+ countries', desc: 'Haul Command now supports escort dispatch operations in 50+ countries, including all major heavy haul markets in North America, Europe, and Asia-Pacific.' },
