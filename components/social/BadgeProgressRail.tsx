...
function BadgeChip({ badge, earned, progress }: { badge: StreakBadge; earned: boolean; progress?: number }) {
    ...
    return (
        <div style={{display: 'flex',alignItems: 'center',gap: 8,padding: '8px 12px',background: earned ? `${color}12` : 'rgba(255,255,255,0.03)',border: `1px solid ${earned ? color + '30' : 'rgba(255,255,255,0.06)'}`,borderRadius: 10,opacity: earned ? 1 : 0.55,transition: 'all 0.15s'}}>
