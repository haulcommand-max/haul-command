...
export const metadata: Metadata = {
  ...
  description: 'Haul Command is the leading dispatch platform for oversize and heavy haul escort services, connecting operators with loads across 50+ countries.',
};
    ...
    <div style={{ minHeight: '100vh', background: 'var(--hc-surface-c)', color: '#fff' }}>
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '80px 24px' }}>
        ...
        <div style={{ fontSize: 16, lineHeight: 1.8, color: 'rgba(255,255,255,0.8)' }}>
          ...
          <p>Founded to solve the fragmentation in the escort vehicle industry, Haul Command provides real-time dispatch, automated compliance verification, rate intelligence, and trust scoring for operators across 50+ countries.</p>
