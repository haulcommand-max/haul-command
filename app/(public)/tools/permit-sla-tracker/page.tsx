...
export default async function PermitSLATrackerPage() {
  ...
  return (
    <>
      ...
      <div data-hc-topic-hero="manual" style={{ minHeight: '100vh', background: '#09050d', color: '#e5e7eb', fontFamily: "'Inter', system-ui" }}>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '2.5rem 1.5rem' }}>
          ...
          <NoDeadEndBlock
            ...
            moves={[
              { href: '/corridors', icon: 'ðŸ›£ï¸', title: 'Route Corridors', desc: 'Find typical routes', primary: true, color: '#a855f7' },
              { href: '/tools/permit-authorities', icon: 'ðŸ›ï¸', title: 'Permit Authorities', desc: 'Direct state links' },
            ]}
          />
        </div>
      </div>
