...
export const metadata: Metadata = {
  ...
  description: 'Find pilot car and escort operator training for your country. State-aware, globally-ready certification pathways in priority markets including USA, Canada, Australia, UK, UAE, and more.',
        ...
        <section style={{ padding: 'clamp(2rem,5vw,4rem) 20px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <div style={{ maxWidth: 1100, margin: '0 auto' }}>
            ...
            <p style={{ margin: '0 0 24px', fontSize: 15, color: '#9ca3af', lineHeight: 1.7, maxWidth: 620 }}>
              Haul Command Training is available in priority markets. Each country page includes localized requirements,
