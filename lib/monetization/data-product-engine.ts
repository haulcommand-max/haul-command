...
export const DATA_PRODUCT_CATALOG: DataProduct[] = [
    ...
    },
    {
        ...
        description: 'Weekly CSV export or live API endpoint with corridor liquidity, shortage zones, and rate benchmarks by state. Built for logistics planners and fleet managers.',
        price_usd: 79,
        purchase_type: 'subscription',
        tier_required: 'enterprise',
        preview_fields: ['corridor_name', 'liquidity_score', 'shortage_flag'],
        full_fields: ['corridor_id', 'liquidity_score', 'shortage_severity', 'rate_benchmark_p50', 'rate_benchmark_p90', 'operator_density', 'fill_rate_7d', 'fill_rate_30d', 'demand_velocity', 'supply_gap_index', 'seasonal_adjustment', 'state_breakdown'],
        refresh_frequency: 'weekly',
        country_scope: ['US', 'CA', 'AU', 'GB', 'DE', 'NL', 'AE', 'BR', 'ZA', 'NZ'],
        active: true,
    },
    {
        id: 'operator-density-map',
        type: 'enterprise_feed',
        name: 'Operator Density Map',
        description: 'Anonymized operator coverage by county and corridor. Sold to logistics companies, insurers, and permit services. GeoJSON + CSV format.',
        price_usd: 59,
        purchase_type: 'subscription',
        tier_required: 'enterprise',
        preview_fields: ['state', 'county_count', 'coverage_score'],
        full_fields: ['county_fips', 'operator_count', 'avg_trust_score', 'avg_response_time_hrs', 'coverage_radius_miles', 'equipment_types', 'certifications_held', 'availability_pct_30d', 'demand_supply_ratio'],
        refresh_frequency: 'weekly',
        country_scope: ['US', 'CA', 'AU', 'GB'],
        active: true,
    },
    {
        ...
        purchase_type: 'one_time',
        tier_required: 'pro',
        preview_fields: ['country', 'avg_rate_per_km'],
        full_fields: ['country_code', 'country_name', 'tier', 'avg_rate_per_km', 'avg_rate_per_mile', 'rate_by_distance_band', 'rate_by_equipment', 'rate_by_season', 'yoy_change_pct', 'operator_count', 'regulatory_surcharge'],
