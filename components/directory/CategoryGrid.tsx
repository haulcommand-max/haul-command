...
const CATEGORIES = [
    {
        ...
        icon: Car,
        description: "Lead car, chase car & certified escorts",
        hot: true,
    },
    {
    ...
    },
    {
        ...
        icon: Wrench,
        description: "Mobile repair, towing & roadside",
        hot: false,
    },
    {
        ...
        icon: FileText,
        description: "OS/OW routing permits & multi-state filings",
        hot: false,
    },
    {
    ...
    },
    {
        ...
        label: "Travel Plazas",
        icon: BedDouble,
        description: "Oversize-friendly truck stops & staging areas",
        hot: false,
    },
    {
        slug: "ports-borders",
        label: "Ports & Borders",
        icon: Map,
        description: "POE, border crossings & port infrastructure",
        hot: false,
    },
    {
    ...
    },
    {
        ...
        icon: Car,
        description: "Lead car, chase car & high-pole units",
        hot: false,
    },
] as const;
