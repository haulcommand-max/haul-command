                        ...
                        <div className="hidden sm:flex" style={{
                            ...
                            {signals.length > 0 ? signals.map((sig, i) => {
                                ...
                                <div style={{
                                    ...
                                    <div style={{ fontSize: 10, color: "#8fa3b8", fontWeight: 600 }}>Active signal: {stat.signals} operators nearby</div>
                                    <div style={{ fontSize: 9, color: "#22c55e", fontWeight: 700, marginTop: 2 }}>{stat.matches} matches today</div>
