...
export const metadata: Metadata = {
    ...
    description: 'Calculate detailed heavy haul escort vehicle costs by region, service type, and wait time using live 2026 market benchmarks across 50+ countries.',
    alternates: {
