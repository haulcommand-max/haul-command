      ...
      <div style={{ display: 'flex', flex: 1, flexWrap: 'wrap' }}>
          ...
          <div style={{ padding: '20px 16px', borderBottom: '1px solid #1a1a22' }}>
            ...
            <div style={{ marginTop: 12 }}>
              ...
              <div style={{ height: 4, background: '#1a1a22', borderRadius: 2, overflow: 'hidden' }}>
                <div style={{
                  height: '100%',
                  width: `${(completedLessonCount / Math.max(totalLessons, 1)) * 100}%`,
            ...
            {moduleProgress?.status === 'passed' && (
              <div style={{
                ...
                borderRadius: 8, fontSize: 12, color: '#22c55e', fontWeight: 700,
                textAlign: 'center',
              }}>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    borderLeftWidth: 3,
                    borderLeftColor: isActive ? tierColor : 'transparent',
                    cursor: (isQuiz && !allLessonsComplete) ? 'not-allowed' : 'pointer',
                    display: 'flex',
                    alignItems: 'center',
                    gap: 10,
                    opacity: (isQuiz && !allLessonsComplete) ? 0.4 : 1,
                    transition: 'background 0.15s',
                  }}
                >
                  <div style={{
                    width: 22, height: 22, borderRadius: '50%', flexShrink: 0,
                    background: isComplete ? '#22c55e' : isActive ? tierColor : '#1a1a22',
                    border: `1px solid ${isComplete ? '#22c55e' : isActive ? tierColor : '#2a2a3a'}`,
          ...
          <div style={{ padding: 16, borderTop: '1px solid #1a1a22' }}>
            <button
              ...
              style={{
                width: '100%',
                padding: '12px',
                background: allLessonsComplete && moduleProgress?.status !== 'passed'
                  ? `linear-gradient(135deg, ${tierColor}, ${tierColor}aa)`
                  : '#1a1a22',
                color: allLessonsComplete && moduleProgress?.status !== 'passed' ? '#000' : '#5a5a6a',
                border: 'none',
                borderRadius: 8,
                fontSize: 13,
                fontWeight: 800,
                cursor: allLessonsComplete && moduleProgress?.status !== 'passed' ? 'pointer' : 'not-allowed',
                transition: 'all 0.2s',
              }}
            >
              {moduleProgress?.status === 'passed'
        ...
        <main style={{ flex: 1, minWidth: 0, overflowY: 'auto' }}>
          {activeLesson ? (
            <div>
              ...
              <div style={{
                ...
                <button
                  ...
                  style={{
                    padding: '10px 18px', borderRadius: 8, border: '1px solid #2a2a3a',
                    background: 'transparent', color: '#6a6a7a', fontSize: 14,
                    cursor: lessons.indexOf(activeLesson) === 0 ? 'default' : 'pointer',
                    opacity: lessons.indexOf(activeLesson) === 0 ? 0.4 : 1,
                  }}
                >
                  ← Previous
                </button>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: '#1a1a22', border: '1px solid #2a2a3a',
            ...
            <div style={{
              padding: 48, textAlign: 'center', color: '#6a6a7a',
            }}>
        ...
        <aside style={{
          ...
          <div style={{
            background: '#111118',
            border: `1px solid ${allLessonsComplete ? tierColor + '30' : '#1a1a22'}`,
            borderRadius: 10,
            padding: 16,
            marginBottom: 16,
          }}>
          ...
          {!allLessonsComplete && (
            <div style={{
              ...
              borderRadius: 8,
              padding: '10px 12px',
              fontSize: 12, color: '#8a8a7a', lineHeight: 1.5,
            }}>
