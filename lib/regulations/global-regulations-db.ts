...
export const REGULATIONS: CountryRegulation[] = [
    ...
    },
    {
        ...
        terminology: { primary: "سيارة مرافقة", secondary: ["escort vehicle", "vehicle companion"], language: "ar" },
        standardLimits: { widthM: 2.60, heightM: 4.50, lengthM: 20.00, weightT: 40 },
        escortThresholds: [
            { condition: "Width > 2.60m OR height > 4.50m", escortsRequired: 1, escortType: "case_by_case", notes: "Permit authority (GAT) specifies" },
            { condition: "Width > 4.00m OR weight > 40t", escortsRequired: 1, escortType: "both", notes: "Ministry of Interior traffic police required" },
            { condition: "Width > 5.00m or highly sensitive routes (Makkah/Madinah)", escortsRequired: 2, escortType: "both", notes: "Police + civil escort; daylight only" },
        ],
        permitSystem: {
            authority: "General Authority for Transport (GAT)",
            url: "https://gat.gov.sa",
            permitTypes: ["Special Load Permit", "Overweight Permit"],
        },
        equipment: ["Warning signs (Arabic + English)", "Amber flashing lights", "Two-way radio", "High-visibility vests"],
        restrictions: ["Haramain zone (Makkah/Madinah) requires advance Ministry of Interior clearance", "Prophet's Mosque corridor restricted to certain hours", "Desert/inland highways recommend minimal night travel"],
        certification: { required: false, details: "No statutory escort certification; carrier responsible for compliance with GAT permit conditions." },
        dataQuality: "medium",
        confidenceState: "partially_verified",
        lastVerified: "2026-04-04",
        lastUpdatedBy: "system",
        voiceAnswer: "In Saudi Arabia, oversize loads exceeding 2.6 meters wide or 4.5 meters tall require a special permit from the General Authority for Transport. Wide loads over 4 meters or heavy loads over 40 tonnes require police escort coordination through the Ministry of Interior. The Haramain zone around Makkah and Madinah requires advance clearance.",
    },
    {
        countryCode: "QA", countryName: "Qatar", tier: "B",
        terminology: { primary: "مركبة مرافقة", secondary: ["escort vehicle", "pilot vehicle"], language: "ar" },
        standardLimits: { widthM: 2.60, heightM: 4.50, lengthM: 20.00, weightT: 40 },
        escortThresholds: [
            { condition: "Width > 2.60m OR height > 4.50m OR weight > 40t", escortsRequired: 1, escortType: "case_by_case", notes: "Ashghal permit determines requirements" },
            { condition: "Width > 4.00m or loads near Doha city centre", escortsRequired: 1, escortType: "both", notes: "Qatar Traffic Police clearance required" },
            { condition: "Width > 5.00m or strategic corridor (QP routes)", escortsRequired: 2, escortType: "both", notes: "Police escort mandatory; advance coordination 72hr minimum" },
        ],
        permitSystem: {
            authority: "Public Works Authority (Ashghal)",
            url: "https://www.ashghal.gov.qa",
            permitTypes: ["Special Transport Permit", "Overweight Permit"],
        },
        equipment: ["Warning signs", "Amber flashing lights", "Two-way radio", "High-visibility markings"],
        restrictions: ["Peak traffic hours (6:30–8:30am, 1–3pm, 5–8pm) restricted in Doha", "Friday morning and Islamic holidays may require special coordination", "QP industrial zones require pre-approval"],
        certification: { required: false, details: "No formal certification required; operators must demonstrate compliance with Ashghal permit conditions." },
        dataQuality: "medium",
        confidenceState: "partially_verified",
        lastVerified: "2026-04-04",
        lastUpdatedBy: "system",
        voiceAnswer: "In Qatar, oversize loads require a special transport permit from Ashghal (the Public Works Authority). Loads wider than 2.6 meters or exceeding 40 tonnes need permits with escort requirements determined by Ashghal. Wide loads over 4 meters or those entering Doha city centre need Qatar Traffic Police coordination. Strategic Qatar Petroleum routes require 72 hours advance notice.",
    },
    {
        countryCode: "MX", countryName: "Mexico", tier: "B",
        terminology: { primary: "carro piloto", secondary: ["vehículo escolta", "banderero", "vehículo de acompañamiento"], language: "es" },
        standardLimits: { widthM: 2.60, heightM: 4.25, lengthM: 31.00, weightT: 66.5 },
        escortThresholds: [
            { condition: "Width 3.10–3.66m", escortsRequired: 1, escortType: "civil", notes: "One carro piloto — front or rear per SCT permit" },
            { condition: "Width > 3.66m or length > 33.5m", escortsRequired: 2, escortType: "civil", notes: "One front, one rear" },
            { condition: "Width > 5.00m or weight > 90t or crossing urban toll plazas", escortsRequired: 2, escortType: "both", notes: "Federal transit police plus carros piloto" },
        ],
        permitSystem: {
            authority: "SICT (Secretaría de Infraestructura, Comunicaciones y Transportes)",
            authorityAbbrev: "SICT",
            permitTypes: ["Permiso especial de circulación", "Autorización SCT", "Permiso extraordinario"],
            url: "https://www.gob.mx/sct",
        },
        equipment: ["CARGA SOBREDIMENSIONADA signs (front + rear)", "Amber flashing lights", "Safety flags", "Two-way radio", "Reflective tape on load"],
        restrictions: ["Night moves (10pm–6am) in 16 major cities prohibited without special exemption", "Mexico City's Circuito Interior may require police-coordinated night moves", "Holiday bans: Dec 24–Jan 2, Easter week, national holidays"],
        certification: { required: false, details: "No statutory certification for carro piloto drivers in federal law; operators comply with permit conditions set by SICT per corridor." },
        dataQuality: "medium",
        confidenceState: "partially_verified",
        lastVerified: "2026-04-04",
        lastUpdatedBy: "system",
        voiceAnswer: "In Mexico, oversize loads need a special permit from SICT. One carro piloto is needed when width exceeds 3.1 meters, and two are required above 3.66 meters wide or 33.5 meters long. Police escorts are required for very wide loads or urban crossings. Night movement in major cities is generally prohibited, and travel is banned during national holidays.",
    },
    {
        countryCode: "IN", countryName: "India", tier: "B",
        terminology: { primary: "escort vehicle", secondary: ["pilot vehicle", "outrider", "ODC escort"], language: "en" },
        standardLimits: { widthM: 2.60, heightM: 4.75, lengthM: 18.00, weightT: 49 },
        escortThresholds: [
            { condition: "ODC width > 3.0m or height > 5.0m", escortsRequired: 1, escortType: "civil", notes: "One front escort mandatory per MoRT&H ODC guidelines" },
            { condition: "ODC width > 4.0m or weight > 80t", escortsRequired: 2, escortType: "civil", notes: "Front and rear escort; route survey required" },
            { condition: "ODC on state highways / urban corridors or night move", escortsRequired: 1, escortType: "both", notes: "Traffic Police coordination per state PWD directive" },
        ],
        permitSystem: {
            authority: "NHAI (National Highways Authority of India) / State PWD",
            authorityAbbrev: "NHAI",
            permitTypes: ["Special Permission (ODC)", "Route Survey Certificate", "State PWD Overload Permit"],
            url: "https://www.nhai.gov.in",
        },
        equipment: ["WIDE LOAD / LONG LOAD signs", "Red beacon on top of load", "Amber flashing lights on escort", "Two-way radio / walkie-talkie", "Reflective chevrons"],
        restrictions: ["State-specific travel windows (most: 6am–10pm)", "Delhi NCR: ODC requires police NOC from Traffic Department", "Narrow bridges require advance route survey by state PWD", "Monsoon season (Jun–Sep): some mountain passes restricted"],
        certification: { required: false, details: "No national certification for ODC escort drivers. State PWDs set qualifications per route permit. Tamil Nadu and Maharashtra have published escort guidelines." },
        dataQuality: "medium",
        confidenceState: "partially_verified",
        lastVerified: "2026-04-04",
        lastUpdatedBy: "system",
        voiceAnswer: "In India, Over-Dimensional Cargo wider than 3 meters requires one front escort vehicle per NHAI and Ministry of Road Transport guidelines. Loads over 4 meters wide or 80 tonnes need front and rear escorts plus a route survey. State police coordination is needed on state highways and in urban areas. Each state has its own travel window restrictions, typically 6am to 10pm.",
    },
    {
        countryCode: "ID", countryName: "Indonesia", tier: "B",
        terminology: { primary: "kendaraan pengawal", secondary: ["escort vehicle", "kendaraan pendamping"], language: "id" },
        standardLimits: { widthM: 2.50, heightM: 4.20, lengthM: 18.00, weightT: 38.00 },
        escortThresholds: [
            { condition: "Width > 2.50m or height > 4.20m (ODOL)", escortsRequired: 1, escortType: "civil", notes: "Private kendaraan pengawal per Ministry permit" },
            { condition: "Width > 3.50m or weight > 60t (heavy corridor)", escortsRequired: 2, escortType: "both", notes: "Polda (regional police) coordination required" },
            { condition: "Java highway corridors (particularly Trans-Java)", escortsRequired: 1, escortType: "both", notes: "Jasa Marga toll operator coordination required" },
        ],
        permitSystem: {
            authority: "Kementerian Perhubungan (Ministry of Transportation)",
            permitTypes: ["STNK Khusus / ODOL Permit", "Izin Usaha Angkutan"],
        },
        equipment: ["Warning signs (Indonesian)", "Amber flashing lights", "Flag men at rear", "Two-way radio"],
        restrictions: ["ODOL (Over Dimension Over Loading) enforcement active since 2023 — zero tolerance on Java highways", "Sumatra and Kalimantan: logging/mining corridors require Polda NOP", "Trans-Java toll: advance notice to Jasa Marga required"],
        certification: { required: false, details: "No statutory national certification. Ministry of Transportation permit conditions define escort requirements per corridor." },
        dataQuality: "medium",
        confidenceState: "partially_verified",
        lastVerified: "2026-04-04",
        lastUpdatedBy: "system",
        voiceAnswer: "In Indonesia, oversize loads are regulated under the ODOL (Over Dimension Over Loading) policy, which has been strictly enforced since 2023. Loads exceeding 2.5 meters wide or 4.2 meters high need permits from the Ministry of Transportation and a private kendaraan pengawal escort vehicle. Loads wider than 3.5 meters or heavier than 60 tonnes need police escort coordination. On the Trans-Java highway, advance coordination with Jasa Marga is required.",
    },
    {
