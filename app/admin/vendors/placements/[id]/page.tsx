        ...
        <div className="max-w-3xl mx-auto px-4 py-10 space-y-6">
            ...
            <div className="rounded-xl border border-white/10 bg-[#121212] p-6 shadow-sm space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                    <button aria-label="Interactive Button" onClick={save} disabled={working}
                    ...
                    <button aria-label="Interactive Button" onClick={() => { set("end_at", nowTs()); save(); }}
                                    ...
                                    return (
                                        <tr key={c.id} className="hover:bg-[#1A1A1A]">
                                            ...
                                            <td className="px-4 py-3">
                                                <button aria-label="Interactive Button" onClick={() => expireConflict(c.id)}
