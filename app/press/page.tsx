...
export default function PressPage() {
  const releases = [
    ...
    { date: '2025-02', title: 'Platform Expands Priority-Market Coverage', desc: 'Haul Command now supports priority-market directory and dispatch workflows in major heavy haul regions.' },
