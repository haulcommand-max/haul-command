...
export const metadata: Metadata = {
  title: 'Heavy Haul Escort Services â€” 14 Categories, 120 Countries | Haul Command',
  ...
  openGraph: {
    title: 'Heavy Haul Escort Services â€” 14 Categories, 120 Countries | Haul Command',
    description: '14-category escort service stack across 120 countries. Pilot cars, permits, insurance, fleet backup, AV escorts, and more â€” all self-serve.',
