  ...
  if (step===6) return (
    <div className=" bg-[#07090d] flex items-center justify-center p-4">
      <div className="text-center max-w-md">
        ...
        <p className="text-sm text-[#8a9ab0] mb-6 leading-relaxed">Your campaign is under review. We typically approve within 2 hours. Youâ€™ll receive an email confirmation shortly.</p>
  ...
  return (
    <div className=" bg-[#07090d] text-[#f0f2f5]">
      <div className="px-4 lg:px-10 py-10 max-w-2xl mx-auto">
        <p className="text-[11px] tracking-[0.2em] text-[#d4950e] font-semibold mb-2">HC ADGRID Â· CAMPAIGN BOOKING</p>
        ...
        <div className="bg-[#0f1a24] border border-[#1e3048] rounded-2xl p-6 mb-6">
                ...
                <div className="grid grid-cols-1 gap-2">
                  {CAMPAIGN_TYPES.map(ct=>(
                    <button key={ct.value} type="button" onClick={()=>set('campaign_type',ct.value)}
                      ...
                      <span className="font-semibold">{ct.label}</span> â€” <span className="text-xs opacity-75">{ct.desc}</span>
                    </button>
                  ))}
                </div>
              </div>
          ...
          {step===3&&(
            <div className="flex flex-col gap-4">
              ...
              <p className="text-xs text-[#566880]">Donâ€™t have creative? Leave body blank and weâ€™ll generate premium creative for you at no extra cost.</p>
        ...
        <div className="flex gap-3">
          ...
          {step<5
            ...
            : <button type="button" onClick={submit} disabled={loading} className="flex-1 bg-[#d4950e] hover:bg-[#c4850e] disabled:opacity-50 text-white font-bold py-3 rounded-xl text-sm">
                {loading?'Submittingâ€¦':'Submit Campaign â†’'}
              </button>
          }
        </div>
      </div>
