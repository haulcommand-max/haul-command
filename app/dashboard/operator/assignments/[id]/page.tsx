            ...
            <div className="bg-slate-900 rounded-xl border border-slate-800 p-6 shadow-xl sticky top-24">
              ...
              {isActive && (
                <div className="mt-6 flex flex-col gap-2">
                  <Button aria-label="Interactive Button" className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-3 rounded-lg shadow-lg">
                    Confirm In-Transit
                  </Button>
                  <Button aria-label="Interactive Button" variant="ghost" className="w-full text-slate-500">
                    Report Issue
                  </Button>
                </div>
              )}
