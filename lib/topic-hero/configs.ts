...
const familyBackground: Record<TopicHeroPageFamily, string> = {
  homepage: "/backgrounds/homepage-hero.jpg",
  tools: "/backgrounds/tools-hero.jpg",
  "tool-detail": "/backgrounds/tools-hero.jpg",
  glossary: "/backgrounds/glossary-hero.jpg",
  "glossary-term": "/backgrounds/glossary-hero.jpg",
  regulations: "/backgrounds/regulations-hero.jpg",
  "regulation-detail": "/backgrounds/regulations-hero.jpg",
  training: "/backgrounds/training-hero.jpg",
  "training-detail": "/backgrounds/training-hero.jpg",
  directory: "/backgrounds/directory-hero.jpg",
  "directory-category": "/backgrounds/directory-hero.jpg",
  profile: "/backgrounds/profiles-hero.jpg",
  "route-intel": "/backgrounds/corridor-hero.jpg",
  corridor: "/backgrounds/corridor-hero.jpg",
  "market-data": "/backgrounds/marketplace-hero.jpg",
  "load-board": "/backgrounds/load-board-hero.jpg",
  "load-detail": "/backgrounds/load-board-hero.jpg",
  country: "/backgrounds/homepage-hero.jpg",
  region: "/backgrounds/homepage-hero.jpg",
  city: "/backgrounds/directory-hero.jpg",
  role: "/backgrounds/profiles-hero.jpg",
  service: "/backgrounds/marketplace-hero.jpg",
  sponsor: "/backgrounds/marketplace-hero.jpg",
  claim: "/backgrounds/profiles-hero.jpg",
  pricing: "/backgrounds/finance-hero.jpg",
...
export const TOPIC_HERO_PRESETS = {
  ...
  directoryHub: buildTopicHeroConfig({
    ...
    heroTier: "tier1",
    h1: "Find the support that keeps an oversize load moving.",
    eyebrow: "Providers, roles, proof states, nearby support, and claim paths",
    subheadline:
      "Search operators, permit help, route survey teams, staging, parking, repair, brokers, suppliers, and support records by location, role, route need, and proof state.",
    microcopy: "Find the right support before the load gets stuck.",
    ...
    tertiaryCTA: { label: "Build support packet", href: "/load-board/post?intent=support-packet", intent: "load_post_intent", style: "ghost" },
    statCards: [
