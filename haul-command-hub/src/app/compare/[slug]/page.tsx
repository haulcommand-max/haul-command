...
const VS_COMPARISONS = [
  { slug: 'pilot-car-loads', competitor: 'Pilot Car Loads', strengths: ['120-country global coverage vs US-only', 'ELD-verified operator profiles', 'Rate intelligence with real market data', 'Corridor sponsorship & premium placements', 'AI-powered load matching (coming)', 'Full escrow & QuickPay payment system'] },
  ...
  { slug: 'bennett-motor-express', competitor: 'Bennett Motor Express', strengths: ['Independent operator marketplace vs single-carrier', 'Multi-carrier rate comparison in real time', '120-country coverage vs US-only fleet', 'Operator-owned profiles with direct contact', 'No exclusive contracts required', 'Transparent pricing with no hidden dispatch fees'] },
