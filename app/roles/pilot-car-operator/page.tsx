...
export const metadata: Metadata = {
    title: 'Pilot Car Operator Hub â€” Find Jobs, Get Listed & Get Verified | Haul Command',
    description:
    ...
    '@graph': [
        ...
        },
        {
            ...
            mainEntity: [
                ...
                { '@type': 'Question', name: 'What certifications do pilot car operators need?', acceptedAnswer: { '@type': 'Answer', text: 'Requirements vary by state but typically include a valid driver\'s license, liability insurance ($300Kâ€“$1M), a PEVO or state-approved escort certification, and in some states a specific pilot car certification card.' } },
...
export default async function PilotCarOperatorPage() {
    ...
    const OPERATOR_NEXT_MOVES = [
        { href: '/loads', icon: 'ðŸ“‹', title: 'Browse Escort Jobs', desc: 'Active loads needing coverage', primary: true, color: gold },
        { href: '/claim', icon: 'âœ“', title: 'Claim Your Free Listing', desc: 'Get found by brokers & carriers', primary: true, color: '#22C55E' },
        { href: '/pricing', icon: 'ðŸ’Ž', title: 'Go Pro â€” Priority Placement', desc: 'Top position in directory' },
        { href: '/escort-requirements', icon: 'âš–ï¸', title: 'State Escort Rules', desc: 'Requirements by jurisdiction' },
        { href: '/rates', icon: 'ðŸ’µ', title: 'Pilot Car Rate Index', desc: 'Current mileage rates by state' },
        { href: '/tools/escort-calculator', icon: 'ðŸ§®', title: 'Escort Calculator', desc: 'How many vehicles required' },
        { href: '/leaderboards', icon: 'ðŸ†', title: 'Operator Leaderboard', desc: 'Top operators by corridor' },
        { href: '/corridors', icon: 'ðŸ›£', title: 'Claim Your Corridors', desc: 'Territory intelligence' },
    ];
            ...
            <main style={{ minHeight: '100vh', background: '#06080f', color: '#e5e7eb' }}>
                    ...
                    <div style={{ maxWidth: 1100, margin: '0 auto', padding: 'clamp(2rem,5vw,4rem) 20px 2rem' }}>
                        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '4px 12px', background: 'rgba(212,168,68,0.1)', border: '1px solid rgba(212,168,68,0.25)', borderRadius: 20, marginBottom: 16 }}>
                            ...
                            <span style={{ fontSize: 11, fontWeight: 700, color: gold, textTransform: 'uppercase', letterSpacing: '0.1em' }}>
                                Live Network Â· {displayCount} Operators
                            </span>
                        </div>
                        ...
                        <div style={{ display: 'flex', gap: 32, flexWrap: 'wrap', alignItems: 'flex-start', justifyContent: 'space-between' }}>
                            <div style={{ flex: 1, minWidth: 280 }}>
                                ...
                                <p style={{ margin: '0 0 24px', fontSize: 16, color: '#9ca3af', lineHeight: 1.7, maxWidth: 560 }}>
                                    The heavy haul industry runs on certified escort vehicles. Find pilot car jobs, claim your free listing, get verified, and dominate your corridors â€” all in one place.
                                </p>
                                <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                                    <Link href="/loads" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 28px', borderRadius: 12, background: `linear-gradient(135deg, ${gold}, #E4B872)`, color: '#000', fontSize: 14, fontWeight: 900, textDecoration: 'none' }}>ðŸ“‹ Find Escort Jobs</Link>
                                    <Link href="/claim" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 24px', borderRadius: 12, background: 'rgba(34,197,94,0.1)', border: '1px solid rgba(34,197,94,0.25)', color: '#22C55E', fontSize: 14, fontWeight: 800, textDecoration: 'none' }}>âœ“ Claim Free Listing</Link>
                                    <Link href="/directory" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 20px', borderRadius: 12, background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', color: '#e5e7eb', fontSize: 14, fontWeight: 700, textDecoration: 'none' }}>ðŸ” Find Operators</Link>
                                </div>
                            </div>
                ...
                <section style={{ maxWidth: 1100, margin: '0 auto', padding: '2rem 20px 1.5rem' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 10, maxWidth: 900, margin: '0 auto' }}>
                        {[
                            { icon: 'ðŸš—', title: "I'm a Pilot Car Operator", desc: 'Find jobs, claim listing, get verified', href: '/loads', color: gold, btn: 'Find Jobs Now' },
                            { icon: 'ðŸ“‹', title: 'I Need Escort Coverage', desc: 'Find operators, post a load, get coverage', href: '/directory', color: '#3B82F6', btn: 'Find Operators' },
                            { icon: 'ðŸš›', title: 'I Run a Carrier / Fleet', desc: 'Manage escorts, compliance, dispatch', href: '/find/pilot-car-operator', color: '#8B5CF6', btn: 'Search Fleet Escorts' },
                            { icon: 'ðŸ“Š', title: "I'm Researching the Market", desc: 'Rates, corridors, operator density', href: '/leaderboards', color: '#22C55E', btn: 'View Intelligence' },
                        ].map(r => (
                            <Link key={r.href + r.title} href={r.href} style={{ display: 'flex', flexDirection: 'column', gap: 6, padding: '18px 16px', borderRadius: 14, textDecoration: 'none', background: `${r.color}0a`, border: `1px solid ${r.color}25` }}>
                                ...
                                <span style={{ fontSize: 12, fontWeight: 700, color: r.color, marginTop: 4 }}>{r.btn} â†’</span>
                            </Link>
                        ))}
                    </div>
                </section>
                ...
                <section style={{ maxWidth: 1100, margin: '0 auto', padding: '0 20px 2rem' }}>
                    <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', padding: '20px 24px', borderRadius: 16, background: 'rgba(212,168,68,0.05)', border: '1px solid rgba(212,168,68,0.15)' }}>
                        <div style={{ flex: 1, minWidth: 240 }}>
                            ...
                            <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.55)', margin: '0 0 14px', lineHeight: 1.5 }}>Verified operators receive 3Ã— more broker contact requests. Upload certs, insurance, and PEVO card â€” get badged and rise in search results.</p>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 8, justifyContent: 'center', minWidth: 180 }}>
                            {['âœ“ Priority search placement', 'âœ“ Verified badge on all listings', 'âœ“ Broker trust signal', 'âœ“ Corridor claim rights'].map(f => (
                ...
                <section style={{ maxWidth: 1100, margin: '0 auto', padding: '0 20px 2.5rem' }}>
                    ...
                    <p style={{ fontSize: 13, color: '#6b7280', margin: '0 0 16px', lineHeight: 1.5 }}>Most active heavy haul markets â€” click any state to see available operators.</p>
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                        ...
                        <Link href="/directory" style={{ padding: '8px 16px', borderRadius: 999, fontSize: 13, fontWeight: 700, background: 'rgba(212,168,68,0.08)', border: '1px solid rgba(212,168,68,0.2)', color: gold, textDecoration: 'none' }}>All 50 States â†’</Link>
                    </div>
                </section>

                {/* Rate Reference */}
                <section style={{ maxWidth: 1100, margin: '0 auto', padding: '0 20px 2.5rem' }}>
                    <h2 style={{ fontSize: 17, fontWeight: 800, color: '#f9fafb', margin: '0 0 14px' }}>Pilot Car Rates â€” What to Charge in {new Date().getFullYear()}</h2>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 10 }}>
                        {[
                            { type: 'Standard Escort', rate: '$1.75â€“$2.75/mi', color: '#9CA3AF' },
                            { type: 'Superload Escort', rate: '$3.50â€“$6.00/mi', color: gold },
                            { type: 'Height Pole Op.', rate: '$4.00â€“$7.00/mi', color: '#D4A844' },
                            { type: 'Day Rate (Avg)', rate: '$350â€“$700/day', color: '#22C55E' },
                            { type: 'Bridge / Utility', rate: '+$50â€“200 flat', color: '#3B82F6' },
                        ].map(r => (
                ...
                <section style={{ maxWidth: 800, margin: '0 auto', padding: '0 20px 2.5rem' }}>
                    ...
                    {[
                        ...
                        { q: 'How much do pilot car operators make per mile?', a: 'Rates range from $1.75 to $2.75/mile for standard escorts, up to $6.00/mile for superload operations. Day rates run $350â€“$700 depending on state, load type, and route complexity.' },
                        { q: 'What certifications do pilot car operators need?', a: 'Requirements vary by state but typically include a valid driver\'s license, liability insurance ($300Kâ€“$1M), a PEVO or state-approved certification, and additional equipment certs for height pole operations.' },
                        { q: 'How do I get pilot car jobs on Haul Command?', a: 'Claim your free Haul Command listing â€” brokers search for available operators by state and specialty. You can also browse the oversize load board directly to bid on open loads needing escort coverage.' },
                ...
                <section style={{ maxWidth: 800, margin: '0 auto', padding: '0 20px 2.5rem' }}>
                    <div style={{ padding: '24px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 16 }}>
                        ...
                        <div style={{ fontSize: 14, color: '#9ca3af', lineHeight: 1.8, display: 'flex', flexDirection: 'column', gap: 12 }}>
                            <p style={{ margin: 0 }}>Pilot car operators â€” also called escort vehicle operators or EVOs â€” are a critical component of every oversize and overweight load movement. Haul Command maintains the most comprehensive directory of certified escort vehicle operators across all 50 US states and 120 countries globally.</p>
                ...
                {/* SEO Internal Links â€” high-equity role page flows equity to tools, directory, glossary */}
