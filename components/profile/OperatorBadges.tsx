// components/profile/OperatorBadges.tsx
...
const BADGE_COLORS: Record<string, string> = {
  verified: '#22c55e',
  elite: '#d4950e',
  top_responder: '#8ab0d0',
  safety_record: '#22c55e',
  veteran: '#d4950e',
  corridor_master: '#9060d0',
  signal_scout: '#c0a030',
  default: '#566880',
};
      ...
      <div className="flex flex-wrap gap-3">
        {badges.map(badge => {
          ...
          return (
            <div
              key={badge.id}
              className={`flex items-center gap-2 px-3 py-2 rounded-xl border text-xs ${isExpired ? 'opacity-40' : ''}`}
