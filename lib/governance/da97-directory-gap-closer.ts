...
export const DA97_DIRECTORY_GAPS: DA97Gap[] = [
  {
    ...
    requiredSurfaces: ['/directory', '/directory/profile/[slug]', '/claim', '/loads', '/available-now', '/report-card/[operatorId]'],
  ...
  },
  {
    ...
    requiredSurfaces: ['/training', '/training/[slug]', '/roles/[role]', '/directory/profile/[slug]', '/tools/certification-reciprocity-checker'],
  ...
  },
  {
    ...
    requiredSurfaces: ['/directory', '/directory/[country]', '/directory/profile/[slug]', '/near-me', '/claim'],
