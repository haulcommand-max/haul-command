...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // ─── GLOSSARY ARCHITECTURE: Unified Canonical Redirects ───────
      // ALL dictionary traffic → glossary (catch-all pattern)
      {
        source: '/dictionary',
      ...
      // Legacy term path normalization
      {
        source: '/pilot-car',
      ...
      // Country-first → topic-first canonical flip
      {
