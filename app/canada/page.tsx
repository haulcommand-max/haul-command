...
const TOP_PROVINCES = [
    { code: 'ab', label: 'Alberta', emoji: 'AB', note: 'Oil sands + pipeline ops' },
    { code: 'bc', label: 'British Columbia', emoji: 'BC', note: 'Port of Vancouver gateway' },
    { code: 'on', label: 'Ontario', emoji: 'ON', note: 'Highway 400 corridor' },
    { code: 'qc', label: 'Quebec', emoji: 'QC', note: 'A-20/A-40 logistics spine' },
    { code: 'sk', label: 'Saskatchewan', emoji: 'SK', note: 'Ag equipment season' },
    { code: 'mb', label: 'Manitoba', emoji: 'MB', note: 'Trans-Canada crossroads' },
];
