        ...
        <div className={cn(
            ...
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                    <button aria-label="Interactive Button" className="flex-1 md:flex-none h-12 flex items-center justify-center gap-2 bg-[#111] hover:bg-[#1a1a1a] border border-[#222] hover:border-[#333] text-white font-bold uppercase tracking-widest text-xs px-6 rounded-xl transition-all">
                        <PhoneCall className="w-4 h-4 text-[#F1A91B]" />
                        Call
                    </button>
                    <button aria-label="Interactive Button" className="flex-1 md:flex-none h-12 px-8 bg-[#F1A91B] hover:bg-[#f0b93a] text-black font-black uppercase tracking-widest text-sm rounded-xl transition-all shadow-[0_0_20px_rgba(241,169,27,0.15)] hover:shadow-[0_0_30px_rgba(241,169,27,0.3)]">
                        Request Escort
                    </button>
                </div>
            </div>
