                    ...
                    <div className={`bg-white/5 border border-white/10 rounded-3xl p-6 sm:p-8 mb-6 ${step !== 1 ? 'opacity-50' : ''}`}>
                        ...
                        {step === 1 && (
                            <>
                                ...
                                <button onClick={() => setStep(2)} className="w-full bg-white text-black py-3 rounded-xl font-black text-sm hover:bg-[var(--color-accent)] transition-all mt-4">GET {selectedName.toUpperCase()} CARD →</button>
                            </>
                        )}
                    </div>
                    <div className={`bg-white/5 border border-white/10 rounded-3xl p-6 sm:p-8 ${step !== 2 ? 'opacity-50 pointer-events-none' : ''}`}>
                        ...
                        {step === 2 && (
                            <div className="space-y-4">
                                ...
                                <button onClick={handleSubmit} disabled={!email || loading} className="w-full bg-[var(--color-accent)] text-black py-4 rounded-xl font-black text-lg hover:bg-white transition-all disabled:opacity-50">{loading ? 'SENDING...' : `SEND MY FREE ${selectedName.toUpperCase()} CARD`}</button>
