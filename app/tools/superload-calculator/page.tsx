...
const STATE_SUPERLOAD: Record<string,{ w:number; h:number; lbs:number; police:string; eng:string; note:string }> = {
  TX: { w:18,  h:16,   lbs:254300, police:'Required â‰¥18ft wide or â‰¥16ft tall', eng:'Required â‰¥180k lbs or â‰¥16ft ht', note:'TX DOT Oversize Permit Office manages superload routing.' },
  CA: { w:16,  h:15.5, lbs:250000, police:'Required â‰¥16ft wide',               eng:'Required â‰¥200k lbs',               note:'Caltrans issues separate SA (Special Authorization) permits.' },
  FL: { w:18,  h:16,   lbs:200000, police:'Required â‰¥18ft wide',               eng:'Required â‰¥200k lbs',               note:'FDOT requires 10-day notice for superloads.' },
  OH: { w:16,  h:15,   lbs:200000, police:'Required â‰¥16ft wide',               eng:'Required â‰¥150k lbs',               note:'OH uses bespoke route analysis for superloads.' },
  WA: { w:18,  h:16,   lbs:200000, police:'Required â‰¥18ft wide',               eng:'Required â‰¥166k lbs',               note:'WSDOT requires engineering study for novel routes.' },
  LA: { w:18,  h:16,   lbs:200000, police:'Required â‰¥18ft wide',               eng:'Required â‰¥200k lbs',               note:'LA DOTD coordinates with parish governments.' },
  AZ: { w:18,  h:16,   lbs:200000, police:'Required â‰¥16ft wide',               eng:'Required â‰¥160k lbs',               note:'ADOT issues superload permits from Phoenix HQ only.' },
  PA: { w:16,  h:15,   lbs:200000, police:'Required â‰¥16ft wide',               eng:'Required â‰¥200k lbs',               note:'PennDOT requires pre-move conference for superloads.' },
  MT: { w:18,  h:17,   lbs:200000, police:'Required â‰¥20ft wide',               eng:'Required â‰¥200k lbs',               note:'MT MDT allows wider loads due to low traffic density.' },
  ND: { w:20,  h:18,   lbs:200000, police:'Discretionary',                       eng:'Required â‰¥200k lbs',               note:'ND allows very wide loads on many rural corridors.' },
}
      ...
      <div className=" bg-[#07090d] text-[#f0f2f5]">
        ...
        <div className="px-4 lg:px-10 py-10 max-w-4xl mx-auto">
          ...
          <div className="bg-[#0f1a24] border border-[#1e3048] rounded-2xl p-6 mb-8">
            ...
            <button className="w-full bg-[#ef4444] hover:bg-[#dc2626] text-white font-bold py-3.5 rounded-xl text-sm transition-colors">Check Superload Status â†’</button>
          ...
          <div className="mb-8">
            <AdGridSponsorSlot regionName="National Coast-to-Coast" type="engineering_firm" countryCode="US" />
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            {[['/tools/permit-cost-calculator','Permit Cost Calculator'],['/tools/axle-weight-calculator','Axle Weight Calculator'],['/tools/load-dimension-checker','Load Dimension Checker'],['/regulations','Regulations Hub']].map(([href,label])=>(
              <Link key={href} href={href} className="text-xs bg-[#0f1a24] border border-[#1e3048] text-[#8ab0d0] px-3 py-2 rounded-lg hover:border-[#ef4444] hover:text-[#ef4444] transition-colors">{label} â†’</Link>
            ))}
          </div>
        </div>
      </div>
