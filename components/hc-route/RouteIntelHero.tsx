  ...
  return (
    <div className="relative overflow-hidden w-full pt-20 pb-24 md:pt-32 md:pb-32 px-4">
      ...
      <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center text-center">
        ...
        >
          Bypass hours of manual research. Ask the Haul Command engine any question about oversize regulations, pilot cars, or permits across 57 countries.
        </motion.p>
        ...
        >
          {[
            { icon: Map, title: '57 Countries', desc: 'Real-time routing data' },
