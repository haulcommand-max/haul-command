      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '40px 24px' }}>
        ...
        {step === 'configure' && (
          <>
            ...
            <div style={{ background: '#111118', border: '1px solid #1a1a22', borderRadius: 16, padding: 28, marginBottom: 20 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(130px, 1fr))', gap: 8 }}>
                {US_STATES.map(s => {
                  ...
                  return (
                    <button key={s.code} onClick={() => toggleState(s.code)} style={{
            ...
            <div style={{ background: '#111118', border: '1px solid #1a1a22', borderRadius: 16, padding: 28, marginBottom: 20 }}>
              ...
              <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                {[
                  ...
                  <button key={opt.val} onClick={() => setPermitType(opt.val)} style={{
            ...
            <button onClick={getQuote} disabled={!selectedStates.length || loading} style={{
