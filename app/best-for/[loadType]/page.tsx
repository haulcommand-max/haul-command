...
const LOAD_TYPES: Record<string, {
    ...
    'oversize-load': {
        name: 'General Oversize Load',
        icon: '📦',
        description: 'Any load exceeding standard legal dimensions. The broadest oversize category — covers loads wider than 8.5 ft, taller than 13.5 ft, or longer than 53 ft.',
        weight: '40,000–200,000 lbs',
        width: '8.5–18 ft',
        height: '13.5–16 ft',
        escortCount: '1–4 escorts (state-dependent)',
        topStates: ['TX', 'CA', 'FL', 'OH', 'PA', 'GA', 'IL', 'NC'],
        permits: '$300–$8,000 per move',
        specialReqs: ['Oversize permit required in every state crossed', 'Escort count depends on dimensions', 'Some states require night moves only', 'Route survey for superloads'],
        bestCorridors: ['TX→LA', 'FL→GA', 'OH→PA', 'IL→IN'],
        avgRate: '$3.20–$6.50/mi',
        ai_answer: 'Any load exceeding 8.5 ft wide, 13.5 ft tall, or 53 ft long is classified oversize and requires a permit in every state crossed. Most loads 8.5-14 ft wide require 1 pilot car; loads over 14 ft wide require 2 or more depending on the state.',
    },
    'wide-load': {
        name: 'Wide Load Transport',
        icon: '🔶',
        description: 'Loads exceeding 8.5 feet in width. Wide loads are the most common oversize category and require a pilot car in most US states above 12 ft wide.',
        weight: '30,000–120,000 lbs',
        width: '8.5–16 ft',
        height: '13–15 ft',
        escortCount: '1–2 escorts (width-dependent)',
        topStates: ['TX', 'FL', 'CA', 'GA', 'NC', 'OH', 'IN', 'TN'],
        permits: '$250–$3,000 per move',
        specialReqs: ['Overwidth permit in all states crossed', '1 escort front typically required', '2 escorts for loads over 14 ft', '"Wide Load" banner required on load vehicle'],
        bestCorridors: ['TX→OK', 'FL→GA', 'OH→PA', 'NC→VA'],
        avgRate: '$2.80–$5.00/mi',
        ai_answer: 'Wide loads (over 8.5ft) need overwidth permits in every state. A single front pilot car is required in most states for loads 12-14ft wide. Two escorts are required for loads over 14ft wide. "Wide Load" banners must be displayed on the back of the escort and the load vehicle.',
    },
    'heavy-haul': {
        name: 'Heavy Haul — Overweight',
        icon: '⚖️',
        description: 'Overweight loads exceeding posted bridge or highway weight limits. Requires special permitting, engineering analysis, and police or certified escorts.',
        weight: '80,000–500,000+ lbs',
        width: '10–16 ft',
        height: '13–16 ft',
        escortCount: '2–8 escorts + possible police',
        topStates: ['TX', 'LA', 'OH', 'PA', 'IN', 'WY', 'ND', 'CO'],
        permits: '$2,000–$20,000 per move',
        specialReqs: ['Superload permit for most heavy haul moves', 'Bridge crossing analysis required', 'Engineer-stamped route survey', 'Police escort in some states and metro areas', 'Night or weekend moves often required'],
        bestCorridors: ['TX→LA', 'WY→CO', 'OH→PA', 'ND→SD'],
        avgRate: '$5.00–$9.00/mi',
        ai_answer: 'Heavy haul moves over 80,000 lbs require a superload permit in most states. An engineer-stamped route survey and bridge crossing analysis are required. Police escorts are required in some states and all major metro crossings. Costs run $5-$9/mile.',
    },
    'manufactured-home': {
        name: 'Manufactured Housing',
        icon: '🏠',
    ...
    'crane': {
        ...
        icon: '🏗️',
        description: 'Mobile cranes, crawler cranes, and crane components. High-weight, complex permits, multiple trailers. Common in construction-dense corridors.',
        weight: '100,000–500,000 lbs',
        width: '12–18 ft',
        height: '13–17 ft',
        escortCount: '2–6 escorts depending on state and weight',
        topStates: ['TX', 'CA', 'FL', 'NY', 'PA', 'OH', 'IL'],
        permits: '$2,000–$15,000 per move',
        specialReqs: ['Superload permit for large cranes', 'Multi-axle trailer configuration required', 'Bridge analysis for all routes', 'Police escort in metro areas', 'Route pre-inspection required'],
        bestCorridors: ['TX→OK', 'CA→AZ', 'OH→PA', 'FL→GA'],
        avgRate: '$5.00–$9.00/mi',
        ai_answer: 'Crane transport requires 2-6 pilot cars depending on weight and state. Superload permits are required for cranes over 150,000 lbs. A bridge analysis and route pre-inspection are required. Police escorts are required in most major metro areas.',
    },
    'utility-poles': {
        name: 'Utility Poles & Transmission',
        icon: '⚡',
        description: 'Wood utility poles, steel transmission towers, and power line components. Long, heavy, and often time-sensitive due to power outage restoration.',
        weight: '20,000–80,000 lbs',
        width: '8–12 ft',
        height: '13–15 ft',
        escortCount: '1–2 escorts',
        topStates: ['TX', 'FL', 'GA', 'NC', 'OH', 'CA', 'WA'],
        permits: '$300–$2,000 per move',
        specialReqs: ['Oversize permit (length) in most states', 'Height pole escort for utility wire clearance', 'Time-sensitive — often emergency/storm response', 'Convoy moves for large quantities'],
        bestCorridors: ['TX→LA', 'FL→GA', 'NC→VA', 'WA→OR'],
        avgRate: '$2.80–$4.50/mi',
        ai_answer: 'Utility pole transport requires a length permit in most states and a height pole escort when wire clearance is an issue. Many moves are emergency storm-response and need expedited permits. Standard loads need 1-2 pilot cars.',
    },
};
