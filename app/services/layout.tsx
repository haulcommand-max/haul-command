...
export const metadata: Metadata = {
  ...
  description: 'Professional pilot car, wide load escort, heavy haul, wind energy transport, route surveys, permit filing, insurance verification, consolidated invoicing, fleet backup & rescue, risk mitigation, certification, autonomous vehicle escort, and equipment marketplace services across priority markets.',
  keywords: [
  ...
  openGraph: {
    title: 'Heavy Haul Escort Services — 14 Categories, 50+ Countries | Haul Command',
    description: '14-category escort service stack across priority markets. Pilot cars, permits, insurance, fleet backup, AV escorts, and more — all self-serve.',
