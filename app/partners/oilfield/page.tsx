...
export const metadata: Metadata = {
  ...
  description: 'Escort operator records for oilfield equipment moves in the Permian Basin, Eagle Ford, Bakken, and oil patch regions across priority oilfield markets. Post a rig move in 90 seconds.',
};
