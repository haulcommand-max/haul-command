...
const COURSE_DATA: Record<string, {
  ...
  'pilot-car-certification': {
    ...
    tagline: 'Certification, verification, reciprocity, and marketplace routing in one path',
    description: 'A practical pilot car certification hub for operators, brokers, and carriers. Covers PEVO basics, equipment readiness, certification verification, reciprocity checks, HC-ID trust score impact, and how certified operators route into Haul Command marketplace demand.',
    tier: 'silver',
    ...
    modules: 6,
    modules_list: [
      { title: 'PEVO Certification Basics', description: 'What certification proves, what it does not prove, and how brokers should verify it' },
      { title: 'Equipment Readiness', description: 'Signs, amber lights, radios, PPE, high pole equipment, and documentation' },
      { title: 'Reciprocity and Jurisdiction Checks', description: 'How certification acceptance changes by state, province, and route' },
      { title: 'HC-ID Verification', description: 'How proof status, expiration, and profile data become machine-readable' },
      { title: 'Marketplace Routing', description: 'How verified credentials support dispatch, scoring, and broker confidence' },
      { title: 'Renewal and Repair Queue', description: 'How expired, missing, or self-reported credentials are corrected' },
    ],
    prerequisites: 'Valid driver license and operator profile or company record',
    outcomes: [
      'Certification status mapped to HC-ID',
      'Profile proof and readiness gaps identified',
      'Reciprocity checker linked to dispatch markets',
      'Equipment checklist connected to RouteReady bundles',
    ],
    certification: 'Verification-ready course and credential path',
    validity: '3 years where applicable',
  },
  'pevo-certification': {
    title: 'PEVO Certification',
    tagline: 'Pilot/Escort Vehicle Operator certification intelligence',
    description: 'PEVO certification training and verification hub for pilot car and escort vehicle operators. Includes Washington PEVO, state reciprocity, equipment requirements, high-pole readiness, insurance proof, and Haul Command profile scoring.',
    tier: 'silver',
    tierLabel: 'PEVO',
    tierColor: '#A8A8A8',
    price: '$265+',
    ...
    modules: 5,
    modules_list: [
      { title: 'PEVO Role and Legal Scope', description: 'Lead, chase, height pole, traffic control, and operator responsibilities' },
      { title: 'Washington PEVO and Reciprocity', description: 'WA PEVO source facts, 3-year cycle, and state-by-state acceptance checks' },
      { title: 'Vehicle and Safety Equipment', description: 'Minimum kit, inspection readiness, and RouteReady proof states' },
      { title: 'Insurance and Proof', description: 'Commercial auto, general liability, E&O, and profile verification' },
      { title: 'Broker Confidence', description: 'How certification becomes one input in trust score, not the whole score' },
    ],
    prerequisites: 'Valid driver license and jurisdiction-specific age/attendance requirements',
    outcomes: [
      'PEVO terminology and proof states standardized',
      'Reciprocity checker connected',
      'Operator profile claim path strengthened',
      'Training, tools, directory, and requirements linked',
    ],
    certification: 'PEVO verification-ready track',
    validity: '3 years where applicable',
  },
  witpac: {
    title: 'WITPAC Wind Transport Certification',
    tagline: 'Wind-industry transport credentialing tied to operator routing',
    description: 'WITPAC certification intelligence for wind blade, tower, nacelle, and renewable-energy heavy transport. Haul Command connects WITPAC proof to wind corridor pages, operator matching, sponsor inventory, and equipment readiness.',
    tier: 'gold',
    tierLabel: 'WITPAC',
    tierColor: '#F5A623',
    price: '$325+',
    ...
    modules: 6,
    modules_list: [
      { title: 'WITPAC Prerequisites', description: 'PEVO or CDL-equivalent prerequisite logic and proof requirements' },
      { title: 'Wind Load Escort Operations', description: 'Blade, tower, nacelle, and renewable-energy movement constraints' },
      { title: 'Wind Corridor Routing', description: 'TX, OK, MN, IA, Great Plains, port, and renewable-energy corridors' },
      { title: 'High Pole and Route Survey Overlay', description: 'Clearance, turning radius, staging, and utility coordination' },
      { title: 'Marketplace Qualification', description: 'How WITPAC-qualified operators become filterable and routable' },
      { title: 'Sponsor and Equipment Layer', description: 'How suppliers and wind transport sponsors attach to the category' },
    ],
    prerequisites: 'Existing PEVO certification or CDL-equivalent prerequisite where applicable',
    outcomes: [
      'WITPAC operator profile tag',
      'Wind transport marketplace routing',
      'Renewable-energy corridor visibility',
      'Equipment and sponsor path eligibility',
    ],
    certification: 'WITPAC verification-ready specialist path',
    validity: '3 years where applicable',
  },
  'washington-pilot-car-certification': {
    title: 'Washington Pilot Car Certification',
    tagline: 'Washington PEVO requirements, verification, and reciprocity',
    description: 'Washington State PEVO certification page for operators and brokers who need to understand certification, validity, equipment, reciprocity, and Haul Command verification before routing work.',
    tier: 'silver',
    tierLabel: 'WA PEVO',
    tierColor: '#A8A8A8',
    price: '$265+',
    ...
    modules: 5,
    modules_list: [
      { title: 'Washington PEVO Overview', description: 'WA PEVO scope, source facts, validity cycle, and WAC reference points' },
      { title: 'Reciprocity Markets', description: 'States where WA PEVO is tracked as full or conditional in the reciprocity graph' },
      { title: 'Certification Lookup', description: 'How Haul Command verifies credential status without faking proof' },
      { title: 'Required Equipment', description: 'Signs, lights, radio, PPE, high pole, and traffic control readiness' },
      { title: 'Profile and Dispatch Impact', description: 'How WA PEVO affects trust score and operator match eligibility' },
    ],
    prerequisites: 'Valid driver license and full attendance requirements where applicable',
    outcomes: [
      'WA PEVO requirement page linked',
      'Reciprocity checker linked',
      'HC-ID proof state connected',
      'Marketplace routing eligibility clarified',
    ],
    certification: 'Washington PEVO verification-ready path',
    validity: '3 years where applicable',
  },
  'pilot-car-recertification': {
    title: 'Pilot Car Recertification',
    tagline: 'Renewal, expiration alerts, and profile trust repair',
    description: 'Recertification path for pilot car operators with expiring PEVO, WITPAC, or third-party credential proof. Built for renewal reminders, profile repair, broker confidence, and market eligibility.',
    tier: 'silver',
    tierLabel: 'Renewal',
    tierColor: '#A8A8A8',
    price: '$165+',
    ...
    modules: 4,
    modules_list: [
      { title: 'Expiration Audit', description: 'Identify expired, stale, missing, or self-reported credential proof' },
      { title: 'Rule Changes', description: 'Review updated state, reciprocity, equipment, and documentation standards' },
      { title: 'Profile Repair', description: 'Update HC-ID, service areas, equipment, insurance, and certification proof' },
      { title: 'Market Unlocks', description: 'Restore eligibility for dispatch, WITPAC, and corridor search visibility' },
    ],
    prerequisites: 'Prior pilot car, PEVO, WITPAC, or equivalent credential',
    outcomes: [
      'Renewal gaps found',
      'Profile proof repaired',
      'Trust score protected',
      'Dispatch eligibility refreshed',
    ],
    certification: 'Renewal and verification path',
    validity: '3 years where applicable',
  },
  'private-team-training': {
    title: 'Private Team Training',
    tagline: 'Fleet, utility, wind, agency, and escort company training intake',
    description: 'Private team training for companies that need pilot car, flagging, high-pole, WITPAC, equipment, and route-support readiness across crews, corridors, and jurisdictions.',
    tier: 'platinum',
    ...
    modules: 8,
    modules_list: [
      { title: 'Team Role Mapping', description: 'Operator, dispatcher, permit, broker, route survey, and safety roles' },
      { title: 'Credential and Proof Audit', description: 'Certifications, insurance, equipment, and profile proof states' },
      { title: 'Route Support Scenarios', description: 'Wind, superload, high pole, staging, and emergency response' },
      { title: 'Company Safety Library', description: 'Reusable briefing, equipment, and pre-trip documentation assets' },
      { title: 'Marketplace Onboarding', description: 'Claim profiles, service areas, corridor tags, and lead routing' },
      { title: 'Score and Report Card Setup', description: 'Training report cards, readiness, and operator confidence metrics' },
      { title: 'AdGrid and Supplier Options', description: 'Sponsor and supplier pathways for equipment and market ownership' },
      { title: 'Follow-Up Operating Plan', description: 'Renewal calendar, compliance reminders, and assignment workflow' },
    ],
    prerequisites: 'Company cohort or agency team',
    outcomes: [
      'Team readiness map',
      'Credential verification workflow',
      'Profile and service-area cleanup',
      'Training-to-marketplace routing',
    ],
    certification: 'Team training proposal and implementation path',
    validity: 'Configured by contract',
  },
