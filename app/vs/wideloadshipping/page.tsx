...
const COMPARISON = [
  { feature:'Operator directory',          hc:true,  hc_note:'source-backed directory and trust signals', comp:true,  comp_note:'US-focused listings' },
  ...
  { feature:'State regulation pages',      hc:true,  hc_note:'All 50 states + priority markets',       comp:false, comp_note:'Basic info, US only' },
  { feature:'SEO-optimised glossary',      hc:true,  hc_note:'500+ terms across priority markets',     comp:false, comp_note:'Not available' },
