...
// ══════════════════════════════════════════════════════════════
// HAUL COMMAND — Dialog (Modal)
// Premium glass overlay with gold close affordance.
// Used for confirmations, detail views, and form modals.
// ══════════════════════════════════════════════════════════════
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-xl font-display font-bold leading-none tracking-tight text-hc-text",
      className
    )}
    {...props}
  />
