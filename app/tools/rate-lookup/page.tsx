            ...
            <div style={{ maxWidth: 1100, margin: '0 auto' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: '2rem' }}>
                    <div>
                            ...
                            <div style={{ display: 'grid', gap: '1.25rem' }}>
                                <div>
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 8 }}>
                                        {Object.entries(CORRIDOR_RATES).map(([k, v]) => (
                                            <button data-tool-interact key={k} onClick={() => setCorridor(k)} style={{
                                ...
                                <div>
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 8 }}>
                                        {Object.entries(SERVICE_TYPES).map(([k, v]) => (
                                            <button data-tool-interact key={k} onClick={() => setService(k)} style={{
                                                padding: '10px 12px', borderRadius: 10, fontSize: 12, fontWeight: 600,
                                ...
                                <div>
                                    ...
                                    <div style={{ display: 'flex', gap: 8 }}>
                                        {[1, 2, 3].map(n => (
                                            <button data-tool-interact key={n} onClick={() => setEscorts(n)} style={{
                        ...
                        <button data-tool-interact onClick={compute} style={{
