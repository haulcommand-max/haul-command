...
const MODE_CONFIG: Record<MarketMode, {
  ...
  live: {
    ...
    headline: 'Sponsor this market — measured placement',
    sub: 'Sponsor availability is reviewed per market. Your brand can appear on approved high-intent placements in this area.',
