      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '32px 20px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 32, flexWrap: 'wrap', gap: 16 }}>
          <div>
            ...
            <p style={{ margin: 0, fontSize: 13, color: '#64748b' }}>
              {activeCnt} active campaign{activeCnt !== 1 ? 's' : ''} · Reach heavy-haul buyers across eligible inventory
            </p>
          </div>
          <button
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '80px 20px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 20 }}>
            ...
            <p style={{ margin: '0 0 24px', fontSize: 14, color: '#334155' }}>Launch your first ad across eligible Haul Command inventory and measured placement zones.</p>
