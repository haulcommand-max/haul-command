...
export const COUNTRY_LOCALES: Record<string, LocaleConfig> = {
    ...
    IN: { iso2: "IN", locale: "hi-IN", fallback: "en", nativeName: "हिन्दी / English", englishName: "Hindi / English", primaryTimezone: "Asia/Kolkata", timezones: ["Asia/Kolkata"], currency: "INR", currencySymbol: "₹", measurementSystem: "metric", dateFormat: "DMY", distanceUnit: "km", weightUnit: "t", thousandsSep: ",", decimalSep: "." },
    ID: { iso2: "ID", locale: "id-ID", fallback: "en", nativeName: "Bahasa Indonesia", englishName: "Indonesian", primaryTimezone: "Asia/Jakarta", timezones: ["Asia/Jakarta", "Asia/Makassar", "Asia/Jayapura"], currency: "IDR", currencySymbol: "Rp", measurementSystem: "metric", dateFormat: "DMY", distanceUnit: "km", weightUnit: "t", thousandsSep: ".", decimalSep: "," },
    TH: { iso2: "TH", locale: "th-TH", fallback: "en", nativeName: "ไทย", englishName: "Thai", primaryTimezone: "Asia/Bangkok", timezones: ["Asia/Bangkok"], currency: "THB", currencySymbol: "฿", measurementSystem: "metric", dateFormat: "DMY", distanceUnit: "km", weightUnit: "t", thousandsSep: ",", decimalSep: "." },
    ...
    VN: { iso2: "VN", locale: "vi-VN", fallback: "en", nativeName: "Tiếng Việt", englishName: "Vietnamese", primaryTimezone: "Asia/Ho_Chi_Minh", timezones: ["Asia/Ho_Chi_Minh"], currency: "VND", currencySymbol: "₫", measurementSystem: "metric", dateFormat: "DMY", distanceUnit: "km", weightUnit: "t", thousandsSep: ".", decimalSep: "," },
    PH: { iso2: "PH", locale: "en-PH", fallback: "en", nativeName: "Filipino / English", englishName: "Filipino / English", primaryTimezone: "Asia/Manila", timezones: ["Asia/Manila"], currency: "PHP", currencySymbol: "₱", measurementSystem: "metric", dateFormat: "MDY", distanceUnit: "km", weightUnit: "t", thousandsSep: ",", decimalSep: "." },
