    ...
    return (
        <main style={{ maxWidth: 1100, margin: '0 auto', padding: '48px 24px' }}>
            ...
            <section style={{ marginBottom: 40, padding: '20px 24px', background: 'rgba(217,119,6,0.06)', border: '1px solid rgba(217,119,6,0.2)', borderRadius: 14 }}>
                <h3 style={{ fontSize: 15, fontWeight: 800, marginBottom: 8 }}>Ã°Å¸â€Â Cross-Border Loads</h3>
                <p style={{ fontSize: 13, color: 'var(--hc-muted, #aaa)', margin: 0, lineHeight: 1.6 }}>
                    Running a US"â€œCanada cross-border load? Haul Command tracks CBSA crossing requirements and can match you with operators licensed in both countries.{' '}
                    <Link aria-label="Navigation Link" href="/border" style={{ color: '#d97706' }}>View border crossing protocols Ã¢â€ â€™</Link>
                </p>
            </section>
            ...
            <section style={{ borderTop: '1px solid var(--hc-border, #222)', paddingTop: 32 }}>
                ...
                <p style={{ fontSize: 14, color: 'var(--hc-muted, #aaa)', lineHeight: 1.7, maxWidth: 700 }}>
                    ...
                    <Link aria-label="Navigation Link" href="/regulatory-db?country=ca" style={{ color: '#d97706' }}>Browse the Canadian regulatory database Ã¢â€ â€™</Link>
                </p>
            </section>
        </main>
    );
