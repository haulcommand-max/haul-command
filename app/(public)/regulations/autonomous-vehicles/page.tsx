...
export const metadata: Metadata = {
  ...
  description:
    'A global resource tracking how autonomous vehicle deployments intersect with escort and oversize load regulations where source data is available. Free.',
  keywords: [
    ...
    <div style={{ minHeight: '100vh', background: '#07090f', color: '#e0e0e6', fontFamily: "'Inter','Segoe UI',sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          ðŸŒ Priority markets · UPDATED MARCH 2026
        </div>
        <h1 style={{
      ...
      <div style={{ maxWidth: 920, margin: '0 auto', padding: '64px 24px' }}>
        ...
        <p style={{ color: '#8fa3c0', marginBottom: 40, fontSize: 15 }}>
          Click any country for escort-specific AV guidance. Priority markets â†’{' '}
