...
export const metadata: Metadata = {
    title: 'Pilot Car Certification by State (2026) — All 50 States | Haul Command',
    ...
    openGraph: {
        ...
        description: '2026 guide to pilot car certification in all 50 states — requirements, reciprocity, and renewal.',
    },
};
...
const STATE_CERTS: StateCert[] = [
    ...
    { code: 'CA', name: 'California', required: true, certBody: 'Caltrans', reciprocity: 'None — CA only', renewal: '2 years', notes: 'Strict state-only certification; written + practical exam', tier: 'strict' },
    ...
    { code: 'FL', name: 'Florida', required: true, certBody: 'FDOT', reciprocity: 'None — FL only', renewal: '2 years', notes: 'Road Ranger exam required; strict equipment standards', tier: 'strict' },
    ...
    { code: 'MA', name: 'Massachusetts', required: true, certBody: 'MassDOT', reciprocity: 'None — MA only', renewal: '2 years', notes: 'Permit class and written test required', tier: 'strict' },
    ...
    { code: 'NJ', name: 'New Jersey', required: true, certBody: 'NJDOT', reciprocity: 'None — NJ only', renewal: '2 years', notes: 'Written exam + NJ-specific equipment requirements', tier: 'strict' },
    ...
    { code: 'NY', name: 'New York', required: true, certBody: 'NYSDOT', reciprocity: 'None — NY only', renewal: '2 years', notes: 'NYC metro has special permit requirements; strict enforcement', tier: 'strict' },
    ...
    { code: 'TX', name: 'Texas', required: true, certBody: 'TxDMV', reciprocity: 'None — TX only', renewal: '2 years', notes: 'Largest escort market in the US; strict certification; TxDMV flag car permit required', tier: 'strict' },
                                ...
                                {STATE_CERTS.map((s, i) => {
                                    ...
                                    return (
                                        <tr key={s.code} style={{ borderBottom: '1px solid rgba(255,255,255,0.04)', background: i % 2 === 0 ? 'transparent' : 'rgba(255,255,255,0.01)' }}>
                                            ...
                                            <td style={{ padding: '10px 12px', fontSize: '0.8rem', color: s.reciprocity === 'None — TX only' || s.reciprocity === 'None — CA only' || s.reciprocity === 'None — NY only' || s.reciprocity === 'None — FL only' || s.reciprocity === 'None — NJ only' || s.reciprocity === 'None — MA only' ? '#ef4444' : '#9ca3af' }}>
                                                {s.reciprocity}
                                            </td>
