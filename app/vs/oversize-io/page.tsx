...
export const metadata: Metadata = {
  ...
  description: 'Haul Command vs OverSize.io: compare source-backed directory workflows, route tools, and operator intelligence.',
...
const ROWS = [
  { feature: 'International market pages', hc: ['Coverage varies', CHECK], hh: ['Tool-focused', PARTIAL] },
  { feature: 'Operator directory', hc: ['Source-backed records', CHECK], hh: ['Limited', PARTIAL] },
  { feature: 'Availability signals', hc: ['Operator-declared where active', CHECK], hh: ['Different model', PARTIAL] },
  ...
  { feature: 'Dispatch workflows', hc: ['Request and match tooling', CHECK], hh: ['Different model', PARTIAL] },
  { feature: 'Load board', hc: ['Integrated', CHECK], hh: ['Basic', PARTIAL] },
  { feature: 'Operator certification', hc: ['Credential signals where present', CHECK], hh: ['Different model', PARTIAL] },
  { feature: 'Rate intelligence', hc: ['Benchmarks where sourced', CHECK], hh: ['Different model', PARTIAL] },
  { feature: 'Geocoded locations', hc: ['23,530+', CHECK], hh: ['No', CROSS] },
  { feature: 'Standing Orders / payment rails', hc: ['Enabled by job status', CHECK], hh: ['Different model', PARTIAL] },
