...
insert into public.hc_training_courses (slug, title, description, tier, price_cents, currency, duration_hours, modules_count, delivery_method, country_codes, hc_trust_score_boost, certification_level, renewal_years, tags, is_featured, sort_order) values
...
insert into public.hc_training_courses (slug, title, description, tier, price_cents, currency, duration_hours, modules_count, delivery_method, country_codes, location_country, language_codes, hc_trust_score_boost, certification_level, renewal_years, tags, is_featured, sort_order) values
...
insert into public.hc_training_courses (slug, title, description, tier, price_cents, currency, duration_hours, modules_count, delivery_method, hc_trust_score_boost, tags, is_featured, sort_order) values
