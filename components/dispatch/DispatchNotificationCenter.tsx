...
function AlertCard({ alert, onMarkRead, onBidOpen, activeBid }: {
  ...
  return (
    <div
      style={{background: isNew ? style.bg : 'rgba(255,255,255,0.015)',border: `1px solid ${isNew ? style.border : 'rgba(255,255,255,0.06)'}`,borderRadius: 16,padding: '16px 18px',transition: 'all 0.2s',cursor: 'pointer'}}
